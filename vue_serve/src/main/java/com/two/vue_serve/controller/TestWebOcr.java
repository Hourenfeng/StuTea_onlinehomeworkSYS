...
import com.two.vue_serve.method.HttpUtil;
...
public class TestWebOcr {
	...
	private static final String TEST_APPID = "627bdaeb";
	// 接口密钥(webapi类型应用开通手写文字识别后，控制台--我的应用---手写文字识别---相应服务的apikey)
	private static final String TEST_API_KEY = "e2710243e05e3ac1aa1c95f4e9db927a";
	// 测试图片文件存放位置
	private static final String IMAGE_FILE_PATH = "https://zjy9823.oss-cn-qingdao.aliyuncs.com/zjy9823/2022-04-09/4.jpg";
	...
	public String ImageRecognition(String url) throws IOException, ParseException {
		Map<String, String> header = constructHeader("en", "false");
		// 读取图像文件，转二进制数组，然后Base64编码
